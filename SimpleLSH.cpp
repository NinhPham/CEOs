...
//        }
        ...
        for (l = 0; l < PARAM_LSH_NUM_DECIMAL; ++l)
        {
            ...
            VECTOR_LSH_CODES[n * PARAM_LSH_NUM_DECIMAL + l] = iHashValue;
        }
...
//            cout << "There is an error! Norm of query " << q << " is: " << vecQuery.norm() << endl;
        ...
        {
            for (l = 0; l < PARAM_LSH_NUM_DECIMAL; ++l)
                vecCounter[n] += __builtin_popcountll(vecI64Hash[l] ^ VECTOR_LSH_CODES[n * PARAM_LSH_NUM_DECIMAL + l]); // ^ XOR
